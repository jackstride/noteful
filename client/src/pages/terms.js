...
const Terms = () => {
  return (
    <div className="policy_container">
      <h4>Welcome to Noteful</h4>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Noteful's Website.
      </p>
      <br />
      <span style={{ textTransform: "capitalize" }}> Noteful</span> is located
      at:
      <br />
      <address>
        <br />
      ...
      <p>
        ...
        conditions in full. Do not continue to use Noteful's website if you do
      ...
      <h4>Cookies</h4>
      <p>
        We employ the use of cookies. By using Noteful's website you consent to
        the use of cookies in accordance with Noteful's privacy policy.
      </p>
      <p>
      ...
      <h4>License</h4>
      <p>
        Unless otherwise stated, Noteful and/or it's licensors own the
        intellectual property rights for all material on Noteful. All
        intellectual property rights are reserved. You may view and/or print
        pages from https://noteful.app for your own personal use subject to
        restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol>
        <li>Republish material from https://noteful.app</li>
        <li>Sell, rent or sub-license material from https://noteful.app</li>
        <li>Reproduce, duplicate or copy material from https://noteful.app</li>
      </ol>
      <p>
        Redistribute content from Noteful (unless content is specifically made
        for redistribution).
      </p>
      ...
      <p>
        ...
        Noteful; and (d) where the link is in the context of general resource
      ...
      <p>
        ...
        e-mail to
        <a
          href="mailto:support@noteful.app"
          title="send an email to support@noteful.app"
        >
          support@noteful.app
        </a>
      ...
      <p>
        No use of Noteful's logo or other artwork will be allowed for linking
      ...
      <p>
        ...
        <a
          style={{ color: "inheirt", textDecoration: "none", cursor: "text" }}
          href="https://termsandconditionstemplate.com/generate/"
        >
