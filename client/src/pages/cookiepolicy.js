...
const CookiePolicy = () => {
  return (
    <div className="policy_container">
      <h4>Cookie Policy for Noteful</h4>

      <p>
        This is the Cookie Policy for Noteful, accessible from
        https://noteful.app
      </p>
      ...
      <p>
        ...
        with one of the features you use on our site. This Cookies Policy was
      ...
      <ul>
        <li>Email: support@noteful.app</li>
      </ul>
    </div>
  );
};
