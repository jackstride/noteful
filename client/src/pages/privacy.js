...
const Privacy = () => {
  return (
    <div className="policy_container">
      <p>
        At Noteful, accessible from https://noteful.app, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Noteful
        ...
        shared and/or collect in Noteful. This policy is not applicable to any
      ...
      <h4>Log Files</h4>
      <p>
        Noteful follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Noteful uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertising partners of Noteful. Third-party ad servers or ad networks
        uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Noteful,
        ...
        that Noteful has no access to or control over these cookies that are
        used by third-party advertisers.
      </p>
      <h4>Third Party Privacy Policies</h4>
      <p>
        Noteful's Privacy Policy does not apply to other advertisers or
        ...
        <h4>CCPA Privacy Rights (Do Not Sell My Personal Information)</h4>Under
      ...
      <p>
        ...
        participate in, and/or monitor and guide their online activity. Noteful
