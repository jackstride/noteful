...
import { removeFolder, addFolder, toggleFolderOpen } from "../../actions/FolderActions";
import {hideMenu,showMenu} from '../../actions/contextMenuActions';
 ...
 class FolderContextMenu extends Component {
   constructor(props){
    ...
    editNote = (e) => {   
      const {pageX,pageY} = e;
      this.props.showMenu(this.props.x,this.props.y,"EditContextMenu",{name: this.props.name,id: this.props.id})
      // this.props.hideMenu();
    }
